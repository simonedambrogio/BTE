...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(37, 35, "end", "model_BMM_estimation");
    return reader;
}
...
public:
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        try {
            ...
            context__.validate_dims("data initialization", "nr", "int", context__.to_vec());
            nr = int(0);
            vals_i__ = context__.vals_i("nr");
            pos__ = 0;
            nr = vals_i__[pos__++];
            check_greater_or_equal(function__, "nr", nr, 0);
            current_statement_begin__ = 4;
            validate_non_negative_index("BCM", "(N * nr)", (N * nr));
            context__.validate_dims("data initialization", "BCM", "int", context__.to_vec((N * nr)));
            BCM = std::vector<int>((N * nr), int(0));
            vals_i__ = context__.vals_i("BCM");
            pos__ = 0;
            size_t BCM_k_0_max__ = (N * nr);
            for (size_t k_0__ = 0; k_0__ < BCM_k_0_max__; ++k_0__) {
                BCM[k_0__] = vals_i__[pos__++];
            }
            size_t BCM_i_0_max__ = (N * nr);
            ...
            validate_non_negative_index("sigma", "(N * nr)", (N * nr));
            context__.validate_dims("data initialization", "sigma", "double", context__.to_vec((N * nr)));
            sigma = std::vector<double>((N * nr), double(0));
            vals_r__ = context__.vals_r("sigma");
            pos__ = 0;
            size_t sigma_k_0_max__ = (N * nr);
            for (size_t k_0__ = 0; k_0__ < sigma_k_0_max__; ++k_0__) {
                sigma[k_0__] = vals_r__[pos__++];
            }
            size_t sigma_i_0_max__ = (N * nr);
            ...
            validate_non_negative_index("BT", "nr", nr);
            context__.validate_dims("data initialization", "BT", "double", context__.to_vec(nr));
            BT = std::vector<double>(nr, double(0));
            vals_r__ = context__.vals_r("BT");
            pos__ = 0;
            size_t BT_k_0_max__ = nr;
            for (size_t k_0__ = 0; k_0__ < BT_k_0_max__; ++k_0__) {
                BT[k_0__] = vals_r__[pos__++];
            }
            size_t BT_i_0_max__ = nr;
            ...
            validate_non_negative_index("R_BMM", "(N * nr)", (N * nr));
            num_params_r__ += (1 * (N * nr));
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        pos__ = 0U;
        validate_non_negative_index("R_BMM", "(N * nr)", (N * nr));
        context__.validate_dims("parameter initialization", "R_BMM", "double", context__.to_vec((N * nr)));
        std::vector<double> R_BMM((N * nr), double(0));
        size_t R_BMM_k_0_max__ = (N * nr);
        for (size_t k_0__ = 0; k_0__ < R_BMM_k_0_max__; ++k_0__) {
            R_BMM[k_0__] = vals_r__[pos__++];
        }
        size_t R_BMM_i_0_max__ = (N * nr);
